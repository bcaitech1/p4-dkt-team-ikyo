...
def parse_args(mode='train'):
    ...
    parser.add_argument('--test_file_name', default='train_test_data.csv', type=str, help='test file name')
    ...
    ### 중요 ###
    parser.add_argument('--model', default='QUA', type=str, help='model type')
