...
def parse_args(mode='train'):
    ...
    parser.add_argument('--run_name', default='pjh-simple-lr1e-3-B4096-L1-emb512', type=str, help='wandb run name')
    parser.add_argument('--seed', default=42, type=int, help='seed')
    
    parser.add_argument('--device', default='cpu', type=str, help='cpu or gpu')

    parser.add_argument('--data_dir', default='/opt/ml/input/data/train_dataset', type=str, help='data directory')
    parser.add_argument('--asset_dir', default='simple_asset/', type=str, help='data directory')
    ...
    parser.add_argument('--max_seq_len', default=1, type=int, help='max sequence length 500 or 19')
